...
class MusicModule {
  ...
  String subGenre() {
    ...
    final prefix = random.element(['Alternative', 'Neo', 'Post', 'Indie', 'Progressive', 'Experimental']);
  ...
  String timeSignature() {
    return random.element(['4/4', '3/4', '6/8', '2/4', '5/4', '7/8', '9/8', '12/8']);
  }

  /// Generates a tempo marking.
  String tempoMarking() {
    return random.element(['Largo', 'Adagio', 'Andante', 'Moderato', 'Allegro', 'Vivace', 'Presto']);
  }
  ...
  String audioFormat() {
    return random.element(['MP3', 'FLAC', 'WAV', 'AAC', 'OGG', 'WMA', 'ALAC', 'DSD', 'AIFF']);
  }
  ...
  String classicalPeriod() {
    return random.element(['Baroque', 'Classical', 'Romantic', 'Modern', 'Contemporary']);
  }
  ...
  static final List<String> _genres = [
    ...
    'Country', 'Blues', 'Reggae', 'Folk', 'Metal', 'Punk', 'Soul',
    'Funk', 'Disco', 'House', 'Techno', 'Dubstep', 'Trap', 'Latin',
    'Gospel', 'Opera', 'Ambient', 'Indie',
  ];

  static final List<String> _instruments = [
    'Guitar', 'Piano', 'Drums', 'Bass', 'Violin', 'Saxophone', 'Trumpet',
    'Flute', 'Cello', 'Clarinet', 'Trombone', 'Harmonica', 'Accordion',
    'Synthesizer', 'Keyboard', 'Ukulele', 'Banjo', 'Mandolin', 'Harp',
    'Oboe', 'French Horn', 'Tuba', 'Xylophone', 'Marimba', 'Tambourine',
  ];

  static final List<String> _composers = [
    'Johann Sebastian Bach', 'Wolfgang Amadeus Mozart', 'Ludwig van Beethoven',
    'Johannes Brahms', 'Richard Wagner', 'Claude Debussy', 'Igor Stravinsky',
    'Pyotr Ilyich Tchaikovsky', 'Frédéric Chopin', 'Antonio Vivaldi',
    'George Gershwin', 'Philip Glass', 'John Williams', 'Hans Zimmer',
  ];

  static final List<String> _adjectives = [
    'Electric', 'Golden', 'Silver', 'Cosmic', 'Midnight', 'Crystal',
    'Velvet', 'Neon', 'Silent', 'Eternal', 'Broken', 'Wild', 'Sacred',
    'Hidden', 'Lost', 'Flying', 'Burning', 'Frozen', 'Dancing', 'Shining',
  ];

  static final List<String> _nouns = [
    'Heart', 'Soul', 'Dream', 'Fire', 'Ocean', 'Mountain', 'Star',
    'Moon', 'Sun', 'Rain', 'Thunder', 'Lightning', 'Shadow', 'Light',
    'Love', 'Hope', 'Fear', 'Joy', 'Pain', 'Memory',
  ];

  static final List<String> _pluralNouns = [
    'Hearts', 'Souls', 'Dreams', 'Stars', 'Shadows', 'Lights',
    'Memories', 'Moments', 'Echoes', 'Waves', 'Flames', 'Stones',
  ];

  static final List<String> _emotions = [
    'Love', 'Joy', 'Sorrow', 'Hope', 'Fear', 'Anger', 'Peace',
    'Longing', 'Happiness', 'Melancholy', 'Ecstasy', 'Despair',
  ];

  static final List<String> _verbs = [
    'Love', 'Need', 'Want', 'Feel', 'Dream', 'Believe', 'Dance',
    'Sing', 'Fly', 'Fall', 'Rise', 'Shine', 'Burn', 'Break',
  ];

  static final List<String> _timeWords = [
    'Night', 'Day', 'Morning', 'Evening', 'Dawn', 'Dusk', 'Midnight',
    'Summer', 'Winter', 'Spring', 'Autumn', 'Yesterday', 'Tomorrow',
  ];

  static final List<String> _colors = [
    'Red', 'Blue', 'Green', 'Yellow', 'Purple', 'Orange', 'Black',
    'White', 'Silver', 'Gold', 'Crimson', 'Azure', 'Emerald',
  ];

  static final List<String> _animals = [
    'Lions', 'Tigers', 'Bears', 'Wolves', 'Eagles', 'Dragons',
    'Phoenixes', 'Ravens', 'Serpents', 'Panthers', 'Falcons',
  ];

  static final List<String> _objects = [
    'Roses', 'Diamonds', 'Mirrors', 'Bridges', 'Towers', 'Gates',
    'Crowns', 'Swords', 'Shields', 'Arrows', 'Chains', 'Keys',
  ];

  static final List<String> _concepts = [
    'Revolution', 'Evolution', 'Redemption', 'Liberation', 'Ascension',
    'Transformation', 'Illumination', 'Revelation', 'Constellation',
  ];

  static final List<String> _bandSuffixes = [
    'Project', 'Collective', 'Orchestra', 'Ensemble', 'Experience',
    'Movement', 'Coalition', 'Society', 'Union', 'Alliance',
  ];

  static final List<String> _singleBandNames = [
    'Genesis', 'Journey', 'Rush', 'Yes', 'Kansas', 'Boston', 'Chicago',
    'America', 'Europe', 'Asia', 'Toto', 'Styx', 'Heart', 'Poison',
  ];

  static final List<String> _firstNames = [
    'John', 'Paul', 'George', 'David', 'Michael', 'James', 'Robert',
    'Mary', 'Jennifer', 'Lisa', 'Sarah', 'Emma', 'Taylor', 'Alex',
  ];
  ...
  static final List<String> _realLabels = [
    'Universal Music', 'Sony Music', 'Warner Music', 'EMI', 'Columbia',
    'Atlantic', 'Capitol', 'Def Jam', 'Motown', 'Blue Note', 'Sub Pop',
  ];

  static final List<String> _cities = [
    'Abbey Road', 'Nashville', 'Memphis', 'Detroit', 'Los Angeles',
    'New York', 'London', 'Berlin', 'Tokyo', 'Paris',
  ];

  static final List<String> _awards = [
    'Grammy Award', 'Billboard Music Award', 'MTV Music Award',
    'American Music Award', 'BRIT Award', 'Mercury Prize',
    'Gold Record', 'Platinum Record', 'Diamond Record',
  ];
  ...
  static final List<String> _moods = [
    'Chill', 'Happy', 'Sad', 'Energetic', 'Relaxing', 'Motivational',
    'Romantic', 'Melancholic', 'Uplifting', 'Peaceful', 'Intense',
  ];

  static final List<String> _activities = [
    'Workout', 'Study', 'Party', 'Road Trip', 'Coffee Shop', 'Sleep',
    'Focus', 'Meditation', 'Running', 'Cooking', 'Reading',
  ];

  static final List<String> _places = [
    'Stars', 'Moon', 'Ocean', 'Mountain', 'City', 'Highway',
    'Rainbow', 'Paradise', 'Heaven', 'Universe', 'Horizon',
  ];

  static final List<String> _soundEffects = [
    'Reverb', 'Echo', 'Delay', 'Chorus', 'Flanger', 'Phaser',
    'Distortion', 'Overdrive', 'Compression', 'EQ', 'Filter',
    'Pitch Shift', 'Auto-Tune', 'Vocoder', 'Tremolo', 'Vibrato',
  ];

  static final List<String> _musicalForms = [
    'Sonata', 'Symphony', 'Concerto', 'Fugue', 'Canon', 'Rondo',
    'Minuet', 'Scherzo', 'Waltz', 'March', 'Prelude', 'Etude',
    'Nocturne', 'Rhapsody', 'Variations', 'Suite',
  ];
}