...
class LoremModule {
  ...
  String sentence({int? wordCount}) {
    ...
    if (sentenceWords.isNotEmpty) {
      sentenceWords[0] = sentenceWords[0][0].toUpperCase() + 
                         sentenceWords[0].substring(1);
    }
  ...
  static final Map<String, List<String>> _enUSData = {
    'words': [
      ...
      'dicta', 'explicabo', 'nemo', 'enim', 'ipsam', 'quia', 'voluptas',
      ...
      'magnam', 'quaerat', 'minima', 'nostrum', 'exercitationem', 'ullam',
      'corporis', 'suscipit', 'laboriosam', 'aliquid', 'commodi', 'consequatur',
      'autem', 'vel', 'eum', 'iure', 'reprehenderit', 'voluptate', 'velit',
      'quam', 'nihil', 'molestiae', 'illum', 'quo', 'fugiat', 'pariatur',
    ],
  };

  static final Map<String, List<String>> _zhTWData = {
    'words': [
      '隨機', '文字', '生成', '測試', '資料', '範例', '內容', '段落',
      '文章', '標題', '描述', '說明', '介紹', '概要', '摘要', '評論',
      '分析', '報告', '研究', '調查', '統計', '數據', '圖表', '結果',
      '方法', '過程', '步驟', '流程', '系統', '功能', '特性', '優點',
      '缺點', '比較', '對比', '差異', '相同', '類似', '關聯', '連結',
      '參考', '來源', '引用', '註解', '備註', '提示', '警告', '錯誤',
      '成功', '失敗', '完成', '開始', '結束', '繼續', '暫停', '停止',
      '更新', '修改', '刪除', '新增', '建立', '設定', '配置', '調整',
      '優化', '改善', '提升', '降低', '增加', '減少', '擴展', '縮小',
      '開啟', '關閉', '啟用', '停用', '顯示', '隱藏', '載入', '儲存',
      '匯出', '匯入', '備份', '還原', '復原', '重置', '清除', '確認',
      '取消', '提交', '送出', '接收', '發送', '傳輸', '下載', '上傳',
      '安裝', '解除', '執行', '運行', '處理', '計算', '驗證', '檢查',
    ],
  };
  ...
  static final Map<String, List<String>> _jaJPData = {
    'words': [
      ...
      'あそこ', 'こちら', 'そちら', 'あちら', 'どこ', 'だれ', 'なに', 'いつ',
      'どう', 'なぜ', 'どちら', 'いくつ', 'いくら', 'ありがとう', 'すみません',
      'ごめんなさい', 'はい', 'いいえ', 'おはよう', 'こんにちは', 'こんばんは',
      'さようなら', 'またね', 'おやすみ', 'いただきます', 'ごちそうさま',
      'お願いします', '失礼します', 'お疲れ様', 'がんばって', 'おめでとう',
      'ようこそ', 'いらっしゃい', 'ただいま', 'おかえり', 'わかりました',
      'わかりません', 'できます', 'できません', 'あります', 'ありません',
      'います', 'いません', '大丈夫', '問題', '質問', '答え', '説明',
      '理解', '勉強', '仕事', '会社', '学校', '家', '部屋', '机',
      '椅子', '本', '新聞', '雑誌', 'テレビ', 'ラジオ', 'パソコン',
      '電話', '携帯', 'メール', 'インターネット', 'ウェブサイト', 'アプリ',
      'ソフトウェア', 'ハードウェア', 'システム', 'プログラム', 'データ',
      'ファイル', 'フォルダ', 'ドキュメント', 'ダウンロード', 'アップロード',
      'インストール', 'アンインストール', '更新', '削除', '作成', '編集',
      '保存', '開く', '閉じる', '実行', '停止', '開始', '終了', '続ける',
    ],
  };
}