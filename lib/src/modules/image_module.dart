...
class ImageModule {
  ...
  String placeholder({int? width, int? height, String? text, String? bgColor, String? textColor}) {
  ...
  String localAvatar({
    ...
    // Generate SVG
    final svg = '''<svg xmlns="http://www.w3.org/2000/svg" width="$avatarSize" height="$avatarSize" viewBox="0 0 $avatarSize $avatarSize">
  $shapeElement
  ...
  String _generateVibrantColor() {
    final colors = [
      ...
      '#DFE6E9', '#74B9FF', '#A29BFE', '#FD79A8', '#6C5CE7',
      '#FDCB6E', '#E17055', '#00B894', '#00CEC9', '#0984E3',
      '#6C5CE7', '#A29BFE', '#FD79A8', '#FDCB6E', '#E17055',
      '#00B894', '#00CEC9', '#0984E3', '#6C5CE7', '#FF7675',
      '#55A3FF', '#FD79A8', '#BADC58', '#F8B739', '#FA8231',
      '#EB3B5A', '#FC5C65', '#45AAF2', '#4B7BEC', '#A55EEA',
      '#26DE81', '#20BF6B', '#FD9644', '#F07C15', '#FC5C65',
    ];
  ...
  String _base64Encode(List<int> bytes) {
    ...
    for (int i = 0; i < bytes.length; i += 3) {
      ...
      result.write(i + 1 < bytes.length ? base64Chars[(bitmap >> 6) & 63] : '=');
  ...
  static final List<String> _categories = [
    'nature', 'people', 'technology', 'food', 'transport',
    'animals', 'business', 'fashion', 'sports', 'abstract',
    'architecture', 'travel', 'city', 'night', 'art',
  ];

  static final List<String> _placeholderColors = [
    'cccccc', '333333', '666666', '999999',
    'ff6b6b', '4ecdc4', '45b7d1', '96ceb4',
    'ffeaa7', 'dfe6e9', 'b2bec3', 'fab1a0',
