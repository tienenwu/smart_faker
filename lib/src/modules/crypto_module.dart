...
class CryptoModule {
  ...
  /// Creates a new instance of [CryptoModule].
  ///
  /// [random] is used for generating random values.
  /// [localeManager] handles localization of crypto data.
  ...
  String nftCollection() {
    final prefix =
        random.element(['Crypto', 'Bored', 'Cool', 'Doodle', 'Pixel', 'Meta']);
    final suffix = random.element(
        ['Punks', 'Apes', 'Cats', 'Dogs', 'Bears', 'Lions', 'Art', 'Club']);
  ...
  String nftRarity() {
    return random
        .element(['Common', 'Uncommon', 'Rare', 'Epic', 'Legendary', 'Mythic']);
  }
