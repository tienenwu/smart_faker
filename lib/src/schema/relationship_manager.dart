...
class SmartRelationshipBuilder {
  ...
  Map<String, dynamic> oneToMany({
    ...
    required List<Map<String, dynamic>> Function(String parentId) childrenGenerator,
  ...
  Map<String, dynamic> hierarchy({
    ...
    required Map<String, dynamic> Function(int depth, String? parentId) nodeGenerator,
    int maxDepth = 3,
  ...
  List<Map<String, dynamic>> sequence({
    required String schema,
    required int count,
    required Map<String, dynamic> Function(int index, Map<String, dynamic>? previous) itemGenerator,
  }) {
